        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: {
                    ...
                    replace: "برای جایگزینی فایل خود را کشیده و اینجا رها کنید یا کلیک کنید",
                    remove: "حذف",
                    error: "اوه! خطایی رخ داده است"
                },
                error: {
                    fileSize: "سایز فایل شما بیشتر از حد مجاز است ({{ value }} حداکثر)",
                    minWidth: "عرض تصویر شما کوچک است ({{ value }}}px حداقل)",
                    maxWidth: "عرض تصویر شما زیاد است ({{ value }}}px حداکثر)",
                    minHeight: "ازتفاع تصویر شما کم است ({{ value }}}px حداقل)",
                    maxHeight: "ارتفاع تصویر شما زیاد است ({{ value }}px حداکثر).",
                    imageFormat: "فرمت تصویر شما مجاز نیست ({{ value }} فقط)",
                    fileExtension: "این فایل مجاز نمی باشد ({{ value }} فقط)"
                },
                tpl: {
