! function(e, t) {
    ...
    var Ce = "ژانویه_فوریه_مارس_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Ue = "ژانویه_فوریه_مارس_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        He = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        Fe = k,
        Le = k;
    ...
    var Je = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        Qe = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
