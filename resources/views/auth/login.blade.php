                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="form-account-row">
                                        <input class="input_second input_all" type="text" placeholder=" شمره موبایل شما"
                                               name="mobile">
                                        @error('mobile')
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="form-account-row">
                                        <input class="input_second input_all" type="password"
                                               placeholder=" رمز عبور شما" name="password">
                                        @error('password')
                                        <span class="invalid-feedback d-block">
                                            <strong>
                                                {{ $message }}
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="widget-menu widget card">
                                ...
                                <div class="License_img">
                                    <a href="#" target="_blank"><img src="{{ asset('assets/img/License_2.png') }}"
                                                                     alt=""></a>
                                    <a href="#" target="_blank"><img src="{{ asset('assets/img/License_1.png') }}"
                                                                     alt=""></a>
                                </div>
                            </div>
